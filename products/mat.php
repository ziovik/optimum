                                ...
                                <thead>
                                      ...
                                      <?php	
                                          if (isset($_GET['mat'])) {
	                                       ...
	                                       $get_mat_pro = "select * from products where product_sub_cat='$mat_id'";
	                                       ...
	                                       if ($count_mat == 0) {
	                                           ...
	                                           while($row_mat_pro=mysqli_fetch_array($run_mat_pro)){
		                                            ...
		                                            $pro_cat = $row_mat_pro['product_cat'];
		                                            $pro_sub_cat = $row_mat_pro['product_sub_cat'];
		  
		                                            $pro_name = $row_mat_pro['product_title'];
		                                            $pro_price = $row_mat_pro['product_price'];
		                                            $pro_desc = $row_mat_pro['product_desc'];
		                                            $pro_dist = $row_mat_pro['dist_id'];
		                                            $pro_manu = $row_mat_pro['product_manu'];
		                              ?>
