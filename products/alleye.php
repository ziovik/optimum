								...
								<table cellspacing="0" id="group-test" class="table table-small-font table-bordered table-striped">
									<thead>
										...
										if (isset($_GET['alleye'])) {
											...
											$get_alleye_pro = "select * from products p 

											join distributors d on p.dist_id = d.dist_id 
											join customers c on d.region_id = c.region_id 
											where c.customer_id = $c_id AND product_cat='$alleye_id'";
											...
											if ($count_alleye == 0) {
												...
												while($row_alleye_pro=mysqli_fetch_array($run_alleye_pro)){
													...
													$pro_cat = $row_alleye_pro['product_cat'];
													$pro_sub_cat = $row_alleye_pro['product_sub_cat'];
													$pro_reg = $row_alleye_pro['region_id'];
													$pro_dist = $row_alleye_pro['dist_id'];
													$pro_name = $row_alleye_pro['product_title'];
													$pro_price = $row_alleye_pro['product_price'];
													$pro_manu = $row_alleye_pro['product_manu'];
													$pro_desc = $row_alleye_pro['product_desc'];
