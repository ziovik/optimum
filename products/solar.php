                                ...
                                <thead>
                                      ...
                                      <?php	
                                          if (isset($_GET['solar'])) {
	                                       ...
	                                       $get_solar_pro = "select * from products where product_sub_cat='$solar_id'";
	                                       ...
	                                       if ($count_solar == 0) {
	                                           ...
	                                           while($row_solar_pro=mysqli_fetch_array($run_solar_pro)){
		                                            ...
		                                            $pro_cat = $row_solar_pro['product_cat'];
		                                            $pro_sub_cat = $row_solar_pro['product_sub_cat'];
		  
		                                            $pro_name = $row_solar_pro['product_title'];
		                                            $pro_price = $row_solar_pro['product_price'];
		                                            $pro_desc = $row_solar_pro['product_desc'];
		                                            $pro_dist = $row_solar_pro['dist_id'];
		                                            $pro_manu = $row_solar_pro['product_manu'];
		                              ?>
