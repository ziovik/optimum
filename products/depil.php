                                ...
                                <thead>
                                      ...
                                      <?php	
                                          if (isset($_GET['depil'])) {
	                                       ...
	                                       $get_depil_pro = "select * from products where product_sub_cat='$depil_id'";
	                                       ...
	                                       if ($count_depil == 0) {
	                                           ...
	                                           while($row_depil_pro=mysqli_fetch_array($run_depil_pro)){
		                                            ...
		                                            $pro_cat = $row_depil_pro['product_cat'];
		                                            $pro_sub_cat = $row_depil_pro['product_sub_cat'];
		  
		                                            $pro_name = $row_depil_pro['product_title'];
		                                            $pro_price = $row_depil_pro['product_price'];
		                                            $pro_desc = $row_depil_pro['product_desc'];
		                                            $pro_dist = $row_depil_pro['dist_id'];
		                                            $pro_manu = $row_depil_pro['product_manu'];
		                              ?>
