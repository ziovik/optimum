                                ...
                                <thead>
                                      ...
                                      <?php	
                                          if (isset($_GET['par'])) {
	                                       ...
	                                       $get_par_pro = "select * from products where product_sub_cat='$par_id'";
	                                       ...
	                                       if ($count_par == 0) {
	                                           ...
	                                           while($row_par_pro=mysqli_fetch_array($run_par_pro)){
		                                            ...
		                                            $pro_cat = $row_par_pro['product_cat'];
		                                            $pro_sub_cat = $row_par_pro['product_sub_cat'];
		  
		                                            $pro_name = $row_par_pro['product_title'];
		                                            $pro_price = $row_par_pro['product_price'];
		                                            $pro_desc = $row_par_pro['product_desc'];
		                                            $pro_dist = $row_par_pro['dist_id'];
		                                            $pro_manu = $row_par_pro['product_manu'];
		                              ?>
