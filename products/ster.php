                                ...
                                <thead>
                                      ...
                                      <?php	
                                          if (isset($_GET['ster'])) {
	                                       ...
	                                       $get_ster_pro = "select * from products where product_sub_cat='$ster_id'";
	                                       ...
	                                       if ($count_ster == 0) {
	                                           ...
	                                           while($row_ster_pro=mysqli_fetch_array($run_ster_pro)){
		                                            ...
		                                            $pro_cat = $row_ster_pro['product_cat'];
		                                            $pro_sub_cat = $row_ster_pro['product_sub_cat'];
		  
		                                            $pro_name = $row_ster_pro['product_title'];
		                                            $pro_price = $row_ster_pro['product_price'];
		                                            $pro_desc = $row_ster_pro['product_desc'];
		                                            $pro_dist = $row_ster_pro['dist_id'];
		                                            $pro_manu = $row_ster_pro['product_manu'];
		                              ?>
