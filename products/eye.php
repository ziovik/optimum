                                ...
                                <thead>
                                      ...
                                      <?php	
                                          if (isset($_GET['eye'])) {
	                                       ...
	                                       $get_eye_pro = "select * from products where product_sub_cat='$eye_id'";
	                                       ...
	                                       if ($count_eye == 0) {
	                                           ...
	                                           while($row_eye_pro=mysqli_fetch_array($run_eye_pro)){
		                                            ...
		                                            $pro_cat = $row_eye_pro['product_cat'];
		                                            $pro_sub_cat = $row_eye_pro['product_sub_cat'];
		  
		                                            $pro_name = $row_eye_pro['product_title'];
		                                            $pro_price = $row_eye_pro['product_price'];
		                                            $pro_desc = $row_eye_pro['product_desc'];
		                                            $pro_dist = $row_eye_pro['dist_id'];
		                                            $pro_manu = $row_eye_pro['product_manu'];
		                              ?>
