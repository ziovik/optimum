                                ...
                                <thead>
                                      ...
                                      <?php	
                                          if (isset($_GET['tatu'])) {
	                                       ...
	                                       $get_tatu_pro = "select * from products where product_sub_cat='$tatu_id'";
	                                       ...
	                                       if ($count_tatu == 0) {
	                                           ...
	                                           while($row_tatu_pro=mysqli_fetch_array($run_tatu_pro)){
		                                            ...
		                                            $pro_cat = $row_tatu_pro['product_cat'];
		                                            $pro_sub_cat = $row_tatu_pro['product_sub_cat'];
		  
		                                            $pro_name = $row_tatu_pro['product_title'];
		                                            $pro_price = $row_tatu_pro['product_price'];
		                                            $pro_desc = $row_tatu_pro['product_desc'];
		                                            $pro_dist = $row_tatu_pro['dist_id'];
		                                            $pro_manu = $row_tatu_pro['product_manu'];
		                              ?>
