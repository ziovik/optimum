                                ...
                                <thead>
                                      ...
                                      <?php	
                                          if (isset($_GET['viz'])) {
	                                       ...
	                                       $get_viz_pro = "select * from products where product_sub_cat='$viz_id'";
	                                       ...
	                                       if ($count_viz == 0) {
	                                           ...
	                                           while($row_viz_pro=mysqli_fetch_array($run_viz_pro)){
		                                            ...
		                                            $pro_cat = $row_viz_pro['product_cat'];
		                                            $pro_sub_cat = $row_viz_pro['product_sub_cat'];
		  
		                                            $pro_name = $row_viz_pro['product_title'];
		                                            $pro_price = $row_viz_pro['product_price'];
		                                            $pro_desc = $row_viz_pro['product_desc'];
		                                            $pro_dist = $row_viz_pro['dist_id'];
		                                            $pro_manu = $row_viz_pro['product_manu'];
		                              ?>
