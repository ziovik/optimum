			...
			<div class="pull-right">
				<ul class="header-top-links">
					...
					if (!isset($_SESSION['customer_id'])) {
						...
						echo "<button style='width:100px;' background:#800080; border-radius:5px;' class='btn next-btn'><a href='../logout.php' class='text-uppercase' style='color:#fff;'>Выйти</a></button>";
